...
We want to render different views for each path (`/login`, `/dashboard`, etc) without reloading the page each time, so we'll use React Router to handle our client-side routing.
